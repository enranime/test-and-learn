...
function nthPrimeApprox(n) {
    ...
    if (n >= 46254381) {
        ...
        const primeBound = (offset) => n * (ln + lnLn - 1 + (lnLn - 2) / ln - (Math.pow(lnLn, 2) - 6 * lnLn + offset) / (2 * Math.pow(ln, 2)));
        ...
        if (n >= 688383) {
            ...
            if (n > 408) {
                ...
                const maxBound = (r) => n * (ln + lnLn * (1 - r));
                if (n >= 49) {
                    max = maxBound(0.4426);
                }
                else {
...
exports.nthPrimeApprox = nthPrimeApprox;
// to run tests:
