...
exports.sieveIntBoost = exports.maxBoostLimit = exports.sieveIntStart = exports.sieveInt = void 0;
...
function* sieveIntStart(start) {
    ...
    if (start >= common_1.maxPrime) {
        if (start === common_1.maxPrime) {
            yield common_1.maxPrime;
        }
        return;
    }
    const sieve = new Map();
...
exports.sieveIntStart = sieveIntStart;
/**
 ...
 */
exports.maxBoostLimit = 100000000;
function sieveIntBoost(n) {
    const length = Math.min(n, exports.maxBoostLimit);
...
exports.sieveIntBoost = sieveIntBoost;
/**
 ...
 */
function sieveOddPrimesTo(bufferLimit) {
